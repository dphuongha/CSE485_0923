...
<body>
    ...
    <div class="container">
        <h3 class="text-center py-3">SỬA THÔNG TIN THỂ LOẠI</h3>
        <?php
        if (isset($_GET['error'])) {
        ...
        <form action="process_edit_category.php" method="post">
            <div class="input-group mb-3" >
                ...
                <input type="text" class="form-control bg-warning" name="matl" readonly> <br>
            </div>
            <div class="input-group mb-3" >
            ...
            <div class="row">
                ...
                <div class="col-md-3"></div>
                <div class="col-md-3">
                    <button class="btn btn-success" type="submit" name="Edit">Cập Nhật</button>
